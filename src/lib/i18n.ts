...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "btn.autoFix": "⚡ Auto-Fix",
    "badge.improved": "Improved",
    "badge.improvedBy": "Improved +{x}",
    "toast.autoFixDone": "Auto-fix applied! Content optimized for higher virality.",
    "btn.revertOriginal": "↩ Revert to Original",
    "result.autoFixedVersion": "⚡ Auto-Fixed Version",
    "result.originalVersion": "📄 Original Version",
  ...
  tr: {
    ...
    "btn.autoFix": "⚡ Otomatik Düzelt",
    "badge.improved": "İyileştirildi",
    "badge.improvedBy": "İyileştirildi +{x}",
    "toast.autoFixDone": "Otomatik düzeltme uygulandı! İçerik daha viral olacak şekilde optimize edildi.",
    "btn.revertOriginal": "↩ Orijinale Dön",
    "result.autoFixedVersion": "⚡ Otomatik Düzeltilmiş Versiyon",
    "result.originalVersion": "📄 Orijinal Versiyon",
